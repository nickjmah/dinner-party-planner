...
export interface GuestDinner {
  ...
  shopping: Array<Pick<ShoppingItem, 'item' | 'quantity' | 'unit' | 'category' | 'purchased' | 'notes' | 'unquantified_required' | 'covered_quantity' | 'component_requirements' | 'covered_components'>>;
